...
class RecursiveList:
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        if len(self) >= index:
            ...
            if index == 0:
                ...
                count = 1
            while count != index and self._rest != None:
                count += 1
            return self._rest
    ...
    def pop(self, index: int) -> Any:
        ...
        if index < len(self):
            if index == 0:
                removed_value = self._first
                self._first = self._rest._first
                self._rest = RecursiveList(self[1:])
                return removed_value
            else:
                count = 1
                while count != index and self._rest != None:
                    count += 1
                removed_value = self._rest._first
    ...
    def insert(self, index: int, item: Any) -> None:
        ...
        if index < len(self):
            if index == 0:
                store_list = self._rest
                self._first = item
                self._rest = store_list
            else:
                count = 1
                while count != index and self._rest != None:
                    count += 1
